...
5. תאים **1, 2, 3**. ריצה חדשה: גם **4**. אחר כך **10** או **12**. אל תריצי 5–9.
6. תא 10: מקורה / הלבשה / עירום. תא **12**: 20 סגנונות עירום בטבע.
...
5. תאים 1, 2, 3. ריצה חדשה: גם 4. אחר כך תא 10 או תא 12. אופציונלי: תא 11.
6. הקובץ כבר ב-Drive: `MyDrive/FiratSuper/loras/lapetitemilf_flux_v2.safetensors`
7. תא 12 = 20 סגנונות עירום בטבע. מבוגרת בלבד.
