...
8. LoRA זכר כבר מאומן. **אל תאמני שוב.** דלגי על 46–51 (נדחו). תא **52** = בדיקת פנים, v2 בלבד.
...
8. דלגי על 41–51. תא **52** = בדיקת פנים, רק v2, בלי LoRA זכר.
...
`lapetitemilf_flux_v2` נעול. אל תאמני. אל תריצי 5–9. דלגי על 46–51 (נדחו).

1. אותה מחברת, A100, תאים 1–4.
2. תא **52** — 2 תמונות פנים בלבד, רק v2 במשקל 1.0. בלי `hrmale`.
