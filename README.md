...
8. LoRA זכר כבר מאומן. **אל תאמני שוב.** דלגי על 46–48 (נדחו). תא **49 או 50 או 51**.
...
8. LoRA זכר: דלגי על 41–48. תא 49 או 50 או 51 (זהות קודם, v2=1.0, זכר=0.7).
...
`lapetitemilf_flux_v2` ו-`henry_penis_flux_v1` כבר על Drive. אל תאמני שוב. אל תריצי 5–9. דלגי על 46–48 (נדחו).

1. אותה מחברת, A100, תאים 1–4.
2. **תא אחד**: 49 = vulva+penis, 50 = פה על הפין, 51 = facial עם semen ו-glans. 5 תמונות.
3. שני ה-LoRA: אישה 1.0, זכר 0.7. הפרומפט מתחיל ב-`ohwx woman` + שיער + עיניים חומות, אחר כך `hrmale`.
